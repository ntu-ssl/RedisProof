...
Definition update_RData_memory(_a: RData) _b :=
  mkRData _b (_a.(time)) (_a.(dict_can_resize)).
Notation "_a '.[memory]' ':<' _b" := (update_RData_memory _a _b) (at level 1).

Definition update_RData_time(_a: RData) _b :=
  mkRData (_a.(memory)) _b (_a.(dict_can_resize)).
Notation "_a '.[time]' ':<' _b" := (update_RData_time _a _b) (at level 1).

Definition update_RData_dict_can_resize(_a: RData) _b :=
  mkRData (_a.(memory)) (_a.(time)) _b.
Notation "_a '.[dict_can_resize]' ':<' _b" := (update_RData_dict_can_resize _a _b) (at level 1).
