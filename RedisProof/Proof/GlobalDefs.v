...
Section GlobalDefs.
  ...
  Definition v_3_1_fptr__dictKeyIndex_spec (v_0: Ptr) (v_1: Ptr) (st: RData) : (option (Z * RData)) :=
    (Some ((dictHashKey_fptr_para v_0 v_1 st), st)).
...
#[global] Hint Unfold v_3_1_fptr__dictKeyIndex_spec: spec.
#[global] Hint Unfold v_8_3_fptr__dictKeyIndex_spec: spec.
